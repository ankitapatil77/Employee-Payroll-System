...
import com.employee_payroll.service.AdminWorkScheduleService;
...
public class AdminWorkScheduleController {
	...
	public ResponseEntity<AdminWorkSchedule> updateWorkSchedule(@PathVariable("id") long id,
		...
		return new ResponseEntity<AdminWorkSchedule>(
				adminWorkScheduleService.updateWorkSchedule(adminWorkSchedule, id), HttpStatus.OK);
	}
